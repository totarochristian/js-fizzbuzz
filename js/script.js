...
for(let i=1; i<=100; i++){
    ...
    squareCont.innerHTML += '<div id="sq_' + i + '" class="square ' + fizz + buzz + ' d-flex justify-content-center align-items-center"><span class="fw-semibold fs-4">' + textToAppend + '</span></div>';
}